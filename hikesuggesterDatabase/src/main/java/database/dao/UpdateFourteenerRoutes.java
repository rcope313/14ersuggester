...
//            ImmutableStoredRoute updatedRoute = FourteenerRouteScraper.scrapeImmutableStoredRoute(routeUrl);
...
//        ArrayList<ImmutableStoredRoute> routes = FourteenerRouteScraper.buildAllImmutableStoredRoutes();
...
//            return "SELECT * FROM " + HikeSuggesterDatabase.FOURTEENER_ROUTES;
//        } else {
//            return "UPDATE " + HikeSuggesterDatabase.FOURTEENER_ROUTES + "\n" +
